 ...
 */
FOUNDATION_EXPORT BOOL MotorBroadcast(NSString* _Nullable addr, NSData* _Nullable tx, NSError* _Nullable* _Nullable error);

FOUNDATION_EXPORT NSData* _Nullable MotorCreateAccount(NSData* _Nullable buf, NSError* _Nullable* _Nullable error);
